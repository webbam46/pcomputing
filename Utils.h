...
/*
	Display  the currently running device
*/
void DisplayRunningDevice(int platform_id,int device_id){ std::cout << "Runinng on " << GetPlatformName(platform_id) << ", " << GetDeviceName(platform_id, device_id) << std::endl; }

/*
	Build kernel/device code
*/
cl::Program BuildKernelCode(cl::Context & context,char * filename) {
	//Load device code
	cl::Program::Sources sources;
	//Add kernel src
	AddSources(sources, filename);
